...
public class StorageUnit
{
  ...
  public StoredItems addStoredItem(String aName, String aDescription, int aId)
  {
    return new StoredItems(aName, aDescription, aId, this);
  }
  ...
  public void delete()
  {
    ...
    {
      StoredItems aStoredItem = storedItems.get(i - 1);
      aStoredItem.delete();
    }
